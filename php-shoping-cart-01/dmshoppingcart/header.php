		...
		<div id="bar">
			<?php				
				...
				if(isset($_SESSION['SESS_LOGGEDIN']) == TRUE)
				{
					...
					"</strong> [<a href='" . $config_basedir . "logout.php'>logout</a>]";
				}
				else if(isset($_SESSION['SESS_ADMINLOGGEDIN']) == TRUE)
				{
					echo "Hello admin: <strong>" . $_SESSION['SESS_ADMIN_NAME'] .
					" </strong> [<a href='" . $config_basedir . "adminlogout.php'>logout</a>]";
				}
				else
				{
